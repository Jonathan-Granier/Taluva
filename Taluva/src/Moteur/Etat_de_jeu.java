...
public class Etat_de_jeu {
	...
	public Etat_de_jeu(Terrain t, Joueur_Generique j1, Joueur_Generique j2, Joueur_Generique j_courant, Phase phase_de_jeu){
		this.terrain = t.clone();
		this.j1 = j1.clone();
		this.j2 = j2.clone();
		this.j_courant = j_courant.clone();
		this.pdj = phase_de_jeu.clone_Phase();
	}
	public Etat_de_jeu()
	{
		//Constructeur vide
	...
	public Etat_de_jeu clone()
	{
		...
		retour.pdj = this.pdj.clone_Phase();
		return retour;
	}
}
